...
class SpanPruner(torch.nn.Module):
    ...
    def forward(self, # pylint: disable=arguments-differ
        ...
        return top_span_embeddings.squeeze(0), top_span_mask.squeeze(-1).squeeze(0), top_span_indices.squeeze(0), top_span_scores.squeeze(0)
